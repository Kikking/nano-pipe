...
echo "quanting..."
time isoquant.py --reference $SIRV_REF --prefix $NAME --genedb $SIRV_ANNO -t 8 --high_memory --bam  /mnt/d/SGNEX/mini_bam/${NAME}.bam --data_type nanopore -o /mnt/d/SGNEX/GTF_files/isoquant/
echo "renaming..." 
