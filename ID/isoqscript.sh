...
echo "quanting..."
time isoquant.py --reference $SIRV_REF  --genedb $SIRV_ANNO --complete_genedb --bam  /mnt/d/SGNEX/mini_bam/index/${NAME}.bam --data_type nanopore -o /mnt/d/SGNEX/isoq/${NAME}
