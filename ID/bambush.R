library(bambu)
  ...
  annotations <- readRDS("E:/refData/current/gencode45_chrIS_SIRV_annotations.rds")
  ...
  #print(sampleData)
  #################
    filepath <- paste0("D:/SGNEX/mini_bam/",sample,".bam") 
    print(filepath)
    ...
    writeBambuOutput(se, paste0("D:/SGNEX/GTF_files/bambu/",sub(".bam", "", sub("D:/SGNEX/mini_bam", "", sample))))
